...
## Communities (150 total, 31 thin omitted)
...
- **Why does `primitive` connect `primitive` to `gray`, `button`, `spacing`, `radius`, `fontSize`, `shadow`?**
